...
<head>
	<meta charset="utf-8">
        ...
        <title> Search Result - Ngebuat.com</title>
</head>
<body>
...
<nav class="navigation row">
                    <div class="navbar-header">
                          <a class="navbar-brand" href="http://ngebuat.com/daeun/home"><img class="logo" src="{{asset('img/LOGO-01.png')}}"></a>
                   </div>
...
<img class="profile-thumbnail nopadding col-md-3" src="../../{{Auth::user()->picture}}"><div class="col-md-8"><span class="nopadding profilename">{{Auth::user()->username}}</span><span class="caret"></span></div><div class="col-md-1"></div>
        ...
        <div class="container80">
                <div class="headerdekorasi whitebackground">
                    <img class="background-headerdekorasi" src="../../img/searchheader.png">
                    <span class="searchheader">{{$search_query}}</span>
                </div>
        </div>
        ...
        <div class="container80 whitebackground leftborder kontendekor">
                <div class="row">
                    ...
                    <div class="col-sm-4 resultpadding">
